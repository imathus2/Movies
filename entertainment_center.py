...
the_jungle_book = media.Movie("The Jungle Book",
    ...
    "15 April 2016", "Jon Favreau", "Drama", "English", 106, "PG")
...
superman_vs_batman = media.Movie("Batman v Superman",
    ...
    "March 19, 2016", "Zack Snyder", "Sci-Fi", "English", 151, "PG-13")

suicide_squad = media.Movie("Suicide Squad",
    "A secret government agency recruits some of the most dangerous incarcerated"
    " super-villains to form a defensive task force. Their first mission: save"
    " the world from the apocalypse.",
    "https://upload.wikimedia.org/wikipedia/en/5/50/Suicide_Squad_%28film%29_Poster.png",
    "https://www.youtube.com/watch?v=CmRih_VtVAs",
    "5 August 2016", "David Ayer", "Sci-Fi", "English", 123, "PG-15")
...
the_martian = media.Movie("The Martian",
    ...
    "30 September 2015", "Ridley Scott", "Drama", "English", 141, "PG")
...
despicable_me = media.Movie("Despicable Me",
    ...
    "15 October 2010", "Chris Renaud", "Animation", "English", 95, "U")
...
spectre = media.Movie("Spectre",
    ...
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMjM2Nzg4MzkwOF5BMl5BanBnXkFtZTgwNzA0OTE3NjE@._V1_QL50_.jpg",
    "https://www.youtube.com/watch?v=z4UDNzXD3qA",
    "26 October 2015", "Sam Mendes", "Thriller", "English", 148, "12A")


# Create the list of all the Movie class instance
movies = [the_jungle_book, superman_vs_batman, suicide_squad, the_martian, despicable_me, spectre]
